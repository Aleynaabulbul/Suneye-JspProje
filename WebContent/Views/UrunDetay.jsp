                    ...
                    <div id="carouselExampleControls" class="carousel slide my-2" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="../img/nakd_square_frame_sunglasses_black_1015-001296-0002_01l-1.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../img/nakd_sharp_triangular_cateye_sunglasses_1015-002505-0002_01l_r4.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../img/Face_detail,_Lt_Mike_Hunter_2_(cropped).jpg" class="d-block w-100" alt="...">
                            </div>
                        </div>
